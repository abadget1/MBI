...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark navbar-expand-md bg-dark justify-content-center">
      <a href="<?php echo site_url('accountant/Accountant/');?>" class="navbar-brand d-flex w-50 mr-auto"><img src="<?php echo base_url(); ?>/assets/images/MBILogo.png"></a>
          ...
          <ul class="navbar-nav w-100 justify-content-center">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="<?php echo site_url('accountant/AccountantJournalController/');?>">View Journals</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
